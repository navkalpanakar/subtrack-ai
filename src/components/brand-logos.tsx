// Real brand logos as inline SVGs for Google, Microsoft, and Apple.
// Used on the login screen and anywhere provider branding appears.
...
export function MicrosoftLogo({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 23 23" role="img" aria-hidden="true">
